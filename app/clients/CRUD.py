...
class crud_management():
    def __init__(self):
        self.DB_PATH = PROJECT_ROOT / "database/characters.db"

    async def db_insertion(self, request: RoleRequest) -> int:
    ...
    async def db_update(self, uuid: str, request: RoleRequest) -> int:
    ...
    async def db_delete(self, uuid: str) -> int:
    ...
    async def db_select(self, uuid: str) -> tuple[str, int]:
